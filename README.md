...
- [X] (2 pts) **Live data is loaded from the NY Times API.**
  - ![Image/GIF showing additional email information](https://i.imgur.com/CLaJnSM.gif) <!-- Replace this link with your actual image/GIF link -->
- [X] (4 pts) **Books are displayed using a RecyclerView.**
  ...
  - ![Image/GIF showing required features](https://i.imgur.com/CLaJnSM.gif) <!-- Replace this link with your actual image/GIF link -->
...
- [X] (4 pts) **Improved layout and styling to match the NY Times website.**
  ...
  - ![Image/GIF showing stretch features](https://i.imgur.com/CLaJnSM.gif) <!-- Replace this link with your actual image/GIF link -->

## Notes

API Key wasn't working in the gradle build file. 
